...
const WorkoutPage = ({ userData, setCurrentPage, setWorkoutDay, setPath }) => {
  ...
  const getTodaysWorkoutTypes = () => {
    ...
    const types = [
      ...new Set(
        todaysExercises.map((exercise) => categorizeExercise(exercise.name))
      ),
    ];
    return types;
  };
  ...
  const getDayWorkoutSummary = (day) => {
    ...
    const types = [
      ...new Set(
        dayData.exercises.map((exercise) => categorizeExercise(exercise.name))
      ),
    ];
  ...
  return (
    <div className="workout-page">
      ...
      <div className="greeting-section">
        <h1>{getGreeting()}</h1>
        <p className="tagline">
          Choose your training path and become stronger!
        </p>
      </div>
      ...
      >
        ...
        <button
          className="start-workout-btn anime-btn glow-effect"
          onClick={() => {
                ...
                <div className="exercise-card-content">
                  <div className="exercise-card-header">
                    <div className="exercise-card-info">
                      <h4>{day}</h4>
                      <p className="exercise-card-type">
