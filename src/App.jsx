    ...
    <ProgressProvider>
      {test ? (
        <>
          ...
          {currentPage === "workout" && (
            <WorkoutPage userData={appData?.user}  setCurrentPage={setCurrentPage}  setWorkoutDay={setWorkoutDay}   setPath={setPath}/>
          )}
          {currentPage === "workout-detail" && (
            <WorkoutDetailPage day={workoutDay}  setCurrentPage={setCurrentPage} path={path}/>
          )}
          {currentPage === "diet" && <DietPage userData={appData?.user} />}
          {currentPage === "progress" && <ProgressPage userData={appData?.user} />}
          {currentPage === "profile" && (
            <ProfilePage userData={appData?.user} onUpdateUser={updateUserData} />
          )}
          <BottomNavigation
          ...
          <div className="app">
            <div className="app-main-content">
              <Routes>
                ...
                <Route
                  path="/"
                  element={<HomeScreen userData={appData?.user} />}
                />
                <Route
                  path="/workout"
                  element={<WorkoutPage userData={appData?.user} />}
                />
